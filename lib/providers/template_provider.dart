...
final templateListProvider = StateNotifierProvider<TemplateListNotifier, List<AllocationTemplate>>((ref) {
...
class TemplateListNotifier extends StateNotifier<List<AllocationTemplate>> {
  ...
  Future<void> saveTemplate(AllocationTemplate template, List<AllocationTemplateItem> items) async {
